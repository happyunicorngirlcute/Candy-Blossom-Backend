 ...
 */
final class Version20260519100507 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plant CHANGE image image VARCHAR(2048) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plant CHANGE image image VARCHAR(255) DEFAULT NULL');
