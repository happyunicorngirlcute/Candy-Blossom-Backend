 ...
 */
final class Version20260429141620 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plant ADD image VARCHAR(255) DEFAULT NULL, ADD sunlight JSON DEFAULT NULL, ADD watering VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plant DROP image, DROP sunlight, DROP watering');
