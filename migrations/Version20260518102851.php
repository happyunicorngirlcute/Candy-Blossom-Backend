 ...
 */
final class Version20260518102851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD name VARCHAR(255) NOT NULL, DROP prenom, DROP nom');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nom VARCHAR(255) NOT NULL, CHANGE name prenom VARCHAR(255) NOT NULL');
