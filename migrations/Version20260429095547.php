 ...
 */
final class Version20260429095547 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_plant ADD id INT AUTO_INCREMENT NOT NULL, ADD city VARCHAR(255) NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_plant MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE user_plant DROP id, DROP city, DROP PRIMARY KEY, ADD PRIMARY KEY (user_id, plant_id)');
    }
}
